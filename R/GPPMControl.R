...
#'
#' @param stanModel logical. Should the corresponding stan model be created? Should only be set to FALSE for testing purposes.
#' Not creating the stan model makes model fitting impossible but saves a lot of time. Its only current use case is for testing purposes.
